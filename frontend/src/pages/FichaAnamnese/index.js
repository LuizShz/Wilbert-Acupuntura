...
export default FichaAmnese = ({ navigation }) => {
  ...
  function handleSubmit (){
    const data = JSON.stringify({
      acupuntura, observacao, interrogatorio, naturezaDoenca, bianZhen, lunZhi, prescricao, cirurgia, medicacao, auriculo, pulsoDireito, pulsoEsquerdo, lingua
    });
    alert(data)
  }
  return (
    <ScrollView>
      ...
      >
        ...
        <View style={styles.container}>
          ...
          <RadioGroup style= {styles.radio} radioButtons={radioAcupuntura} onPress={setAcupuntura} selectedId ={acupuntura} />
          ...
          <TextInput style={styles.input}
            ...
            numberOfLines={6}
            placeholder="Digite seu texto"
            onChangeText={newInterrogatorio=> setInterrogatorio(newInterrogatorio)}
          ...
          <TextInput style={styles.input}
            ...
            onChangeText={newNaturezaDoenca=> setNaturezaDoenca(newNaturezaDoenca)}
          ...
          <TextInput style={styles.input}
            ...
            onChangeText={newPulsoEsquerdo=> setPulsoEsquerdo(newPulsoEsquerdo)}
